...
for n in range(0,nbr):
    PDFfile=open('C:\\Users\zexal\Desktop\hackathon MC2i\gestionCV\CVechantillon\\'+name[n],"rb")
    ...
    for line in getPDFLine('C:\\Users\zexal\Desktop\hackathon MC2i\gestionCV\CVechantillon\\'+name[n]):
        xByline.append(line)
